...
namespace HackathonApp.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult UserDetails()
        {
            ...
            var showuser = db.Users.Where(x => x.Id == userid).FirstOrDefault();
            RegisterViewModel model = new RegisterViewModel();
            if (showuser != null)
            {
                model.Address = showuser.Address;
                model.Bdate = showuser.Bdate;
                model.Contact = showuser.PhoneNumber;
                model.Email = showuser.Email;
                model.FirstName = showuser.FirstName;
        ...
        public ActionResult EditProfile()
        {
            ...
            RegisterViewModel viewModel = new RegisterViewModel { Address = user.Address, FirstName = user.FirstName, Contact = user.PhoneNumber, LastName = user.LastName, Bdate = user.Bdate, ProfilePic = user.Image };
        ...
        public ActionResult EditProfile(RegisterViewModel model)
        {
            var db = new ApplicationDbContext();
            var userid = User.Identity.GetUserId();
            var getuser = db.Users.Where(x => x.Id == userid).FirstOrDefault();
            var dateb = getuser.Bdate;
            ...
            if (model.Contact == null)
                ...
                getuser.PhoneNumber = model.Contact;
            ...
            if(model.ImageFile != null)
            {
                ...
                name = name + extension;
                getuser.Image = "" + name;
                name = Path.Combine(Server.MapPath("../NewFolder1/"), name);
                model.ImageFile.SaveAs(name);
